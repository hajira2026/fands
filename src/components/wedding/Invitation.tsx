...
const Invitation = () => (
  <section className="relative py-[120px] md:py-[160px] px-6 flex justify-center">
    <div className="reveal max-w-[600px] w-full relative">
      <FloralCorners size={140} />
      <div className="glass-card rounded-sm p-8 md:p-14 text-center light-sweep relative">
        ...
        <h2 className="mt-6 font-display text-3xl md:text-5xl text-3d-gold" style={{ color: "#E5C870" }}>
          Nikah Ceremony
        </h2>
